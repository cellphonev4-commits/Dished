...
document.addEventListener('DOMContentLoaded', () => {
  // Grab stored user, or default to Guest if empty
  const currentUser = JSON.parse(localStorage.getItem('currentUser')) || {
    name: "Guest",
    email: "guest@example.com"
  };

  // DO NOT include window.location.href = 'index.html' here!

  // 2. Safely populate user details in the UI
  ...
  // 3. Render your recipes and counts as normal
...
function handleLogout() {
  ...
  // window.location.href = 'index.html'; // Temporarily commented out
}